...
doc_site: $(SITE_DIR)/favicon.ico $(SITE_DIR)/bettongia-docs.css $(SITE_DIR)/index.html $(SITE_DIR)/spec.html $(SITE_DIR)/roadmap.html  $(SITE_DIR)/api/index.html coverage
.PHONY: site
...
$(SITE_DIR)/bettongia-docs.css: | $(SITE_DIR)
	cp $(DOCS_DIR)/template/bettongia-docs.css $(SITE_DIR)/bettongia-docs.css
